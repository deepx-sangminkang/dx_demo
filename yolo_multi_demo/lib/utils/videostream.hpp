...
//for GetInputStream
    ...
    int _fillPadvalue;
    float _preprocRatio;
    dxdemo::common::Size _resizeSize;
    float _dw, _dh;
...
//for Input Alignment
    ...
    VideoStream(AppInputType srcType, std::string srcPath, int preLoadNum, dxdemo::common::Size npuSize, AppInputFormat npuColorFormat, dxdemo::common::Size dstSize, std::shared_ptr<dxrt::InferenceEngine> inferenceEngine, int cam_fps = 30, int cam_width = 1280, int cam_height = 720)
    ...
    //Preprocess 
        ...
        _resizeSize = dxdemo::common::Size((int)(_srcSize._width * _preprocRatio), (int)(_srcSize._height * _preprocRatio));
    ...
    //Display
    void DrawBox(cv::Mat& dst, dxdemo::common::Object& obj)
    {
    ...
    void DrawCaption(cv::Mat& dst, dxdemo::common::Object& obj)
    {
        int textBaseLine = 0;
    ...
    void DrawPoseKpt(cv::Mat& dst, dxdemo::common::Object& obj)
    {
    ...
    void DrawFaceKpt(cv::Mat& dst, dxdemo::common::Object& obj)
    {
        for(size_t idx=0;idx<obj._bbox._kpts.size();++idx)
        {
            auto point = obj._bbox._kpts[idx];
    ...
    cv::Mat GetOutputStream(dxdemo::common::DetectObject& obj)
    {
        cv::Mat dstImg;
        if(_srcType == ISP)
        {
    ...
    void DrawBox(int box_id, dxdemo::common::Object& obj)
    {
        int y, cb, cr;
    ...
    void DrawCaption(int box_id, dxdemo::common::Object& obj)
    {
